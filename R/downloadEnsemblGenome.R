...
.downloadURLs <- function(urls, outputDir) {
    ...
    ## FIXME THIS ASSERT CHECK IS FAILING ARGH.
...
## FIXME RETURN ALL FILES GENERATED BY THIS.
...
.downloadEnsemblTranscriptome <-
    function(
        ...
        ## FIXME NEED TO REENABLE allAreFiles assert check, once we fix goalie...
        ...
        ## FIXME NEED TO CAPTURE THE FILE PATHS HERE.
