...
#'   %in% append as.data.frame complete.cases decode do.call encode expand grep
#'   grepl gsub head is.unsorted lapply match mcols mcols<- metadata metadata<-
#'   order ranges setdiff sort split tail trim unlist
