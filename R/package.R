...
#' as.DataFrame camelCase export import kebabCase leftJoin makeNames matchNested
#' mutateAt rbindToDataFrame removeNa sanitizeNa snakeCase stripExonVersions
...
#' seqnames<- seqnames
#' @importFrom IRanges gsub ranges startsWith toupper trim
